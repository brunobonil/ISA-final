...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'fbae8616-42ec-4670-b4b6-8d994a42c42a' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('459723d2-ed81-4653-9acf-cd84bf3a8eb7');
      cy.get(`[data-cy="name"]`).should('have.value', '459723d2-ed81-4653-9acf-cd84bf3a8eb7');
